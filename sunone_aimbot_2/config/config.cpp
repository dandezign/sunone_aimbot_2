...
training_sam3_presets_dir = "models/presets";
    ...
    training_sam3_box_a = get_long("training_sam3_box_a", 200);
    training_sam3_box_r = get_long("training_sam3_box_r", 0);
    training_sam3_box_g = get_long("training_sam3_box_g", 255);
    training_sam3_box_b = get_long("training_sam3_box_b", 100);
    training_sam3_box_thickness = static_cast<float>(get_double("training_sam3_box_thickness", 2.0));
