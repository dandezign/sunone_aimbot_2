...
def validate_skill_name(skill_name):
    ...
    if len(skill_name) > 40:
        return False, "Skill name must be 40 characters or fewer"
    return True, ""
...
def main():
    ...
    parser.add_argument("--path", required=True, help="Parent directory for new skill")
